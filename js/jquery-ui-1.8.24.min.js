...
(function(a, b) {
    a.widget("ui.accordion", {
        ...
        _keydown: function(b) {
            ...
            return f ? (a(b.target).attr("tabIndex", -1),
            a(f).attr("tabIndex", 0),
            f.focus(),
            !1) : !0
        },
...
(function(a, b) {
    ...
    a.widget("ui.autocomplete", {
        ...
        _initSource: function() {
            var b = this, c, d;
            a.isArray(this.options.source) ? (c = this.options.source,
            this.source = function(b, d) {
                d(a.ui.autocomplete.filter(c, b.term))
            }
            ) : typeof this.options.source == "string" ? (d = this.options.source,
...
(function(a, b) {
    ...
    a.extend(a.ui.dialog.overlay, {
        ...
        height: function() {
            var b, c;
            return a.browser.msie && a.browser.version < 7 ? (b = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight),
...
(function(a, b) {
    ...
    a.widget("ui.tabs", {
            ...
            this.anchors.bind(e.event + ".tabs", function() {
                ...
                if (e.collapsible) {
                    if (c.hasClass("ui-tabs-selected"))
                        ...
                        !1;
                    if (!f.length)
                        return e.cookie && d._cookie(e.selected, e.cookie),
                        d.element.queue("tabs", function() {
                            n(b, g)
                        }),
        ...
        disable: function(a) {
            ...
            var b = this
              , c = this.options;
            return a != c.selected && (this.lis.eq(a).addClass("ui-state-disabled"),
            c.disabled.push(a),
            c.disabled.sort(),
    ...
    a.extend(a.ui.tabs.prototype, {
        ...
        rotate: function(a, b) {
            ...
            return a ? (this.element.bind("tabsshow", e),
        ...
        return this.queue(function() {
            ...
            if (l == "content" || l == "both")
                ...
                c.find("*[width]").each(function() {
                    ...
                    q.from.y != q.to.y && (c.from = a.effects.setTransition(c, h, q.from.y, c.from),
                    c.to = a.effects.setTransition(c, h, q.to.y, c.to)),
                    q.from.x != q.to.x && (c.from = a.effects.setTransition(c, i, q.from.x, c.from),
                    c.to = a.effects.setTransition(c, i, q.to.x, c.to)),
                    c.css(c.from),
